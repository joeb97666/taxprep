              ...
              <Collapsible className="grid gap-4">
                ...
                <CollapsibleContent>
                  <div className="-mx-6 grid gap-6 bg-gray-100 p-6 dark:bg-gray-800">
                    <Link className="group grid h-auto w-full justify-start gap-1" href="#/TaxPrep">
                      <div className="text-sm font-medium leading-none group-hover:underline">Tax Preparation</div>
                ...
                <div className="grid w-[400px] p-2">
                  ...
                  <NavigationMenuLink asChild>
                    <Link
                      ...
                      href="./BookKeep"
                    >
                      <div className="text-sm font-medium leading-none group-hover:underline">Book Keeping</div>
                      <div className="line-clamp-2 text-sm leading-snug text-gray-500 dark:text-gray-400">
                      From creating your chart of accounts to Financial Statement Preparation.
                      </div>
                    </Link>
                  </NavigationMenuLink>
                  <NavigationMenuLink asChild>
                    <Link
                      ...
                      href="./Consulting"
                    >
                      <div className="text-sm font-medium leading-none group-hover:underline"> Consulting</div>
                      <div className="line-clamp-2 text-sm leading-snug text-gray-500 dark:text-gray-400">
                      Business consulting.
                      </div>
                    </Link>
